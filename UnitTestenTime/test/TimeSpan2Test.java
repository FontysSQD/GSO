...
public class TimeSpan2Test {
    ...
    public void testIsPartOfTrue() throws Exception {
        Boolean isPartOf = timeSpan.isPartOf(new TimeSpan2(new Time(2015, 1, 1, 11, 11), new Time(2020, 2, 22, 22, 22)));
        Assert.assertEquals(true, isPartOf);
    }

    @Test
    public void testIsPartOfFalse() throws Exception {
        Boolean isPartOf = timeSpan.isPartOf(new TimeSpan2(new Time(2010, 1, 1, 11, 11), new Time(2020, 2, 22, 22, 22)));
        Assert.assertEquals(false, isPartOf);
    }

    @Test
    public void testUnionWithGood() throws Exception {
        TimeSpan2 timeSpanUnion = (TimeSpan2) timeSpan.unionWith(new TimeSpan2(new Time(2015, 1, 1, 11, 11), new Time(2030, 2, 22, 22, 22)));
    ...
    public void testUnionWithGood2() throws Exception {
        TimeSpan2 timeSpanUnion = (TimeSpan2) timeSpan.unionWith(new TimeSpan2(new Time(2010, 1, 1, 11, 11), new Time(2020, 2, 22, 22, 22)));
    ...
    public void testUnionWithNull() throws Exception {
        TimeSpan2 timeSpanUnion = (TimeSpan2) timeSpan.unionWith(new TimeSpan2(new Time(2005, 1, 1, 11, 11), new Time(2010, 2, 22, 22, 22)));
        Assert.assertEquals(null, timeSpanUnion);
    }

    @Test
    public void testIntersectionWithGood() throws Exception {
        TimeSpan2 timeSpanIntersection = (TimeSpan2) timeSpan.intersectionWith(new TimeSpan2(new Time(2015, 1, 1, 11, 11), new Time(2030, 2, 22, 22, 22)));
    ...
    public void testIntersectionWithGood2() throws Exception {
        TimeSpan2 timeSpanIntersection = (TimeSpan2) timeSpan.intersectionWith(new TimeSpan2(new Time(2010, 1, 1, 11, 11), new Time(2020, 2, 22, 22, 22)));
    ...
    public void testIntersectionWithNull() throws Exception {
        TimeSpan2 timeSpanIntersection = (TimeSpan2) timeSpan.intersectionWith(new TimeSpan2(new Time(2005, 1, 1, 11, 11), new Time(2010, 2, 22, 22, 22)));
